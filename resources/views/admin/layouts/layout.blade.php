...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{ URL::asset('/assets/admin/plugins/pace-progress/themes/black/pace-theme-flat-top.css') }}">
        @yield('css-libraries')
        @yield('inline-css')
    </head>
    <body class="hold-transition sidebar-mini pace-primary">
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
                ...
                <div class="sidebar">
                    ...
                    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                        ...
                        <div class="info">
                            <a href="javascript:void(0)" class="d-block">{{ Auth::user()->short_name }}</a>
                        </div>
                    </div>
                    <!-- SidebarSearch Form -->
                    <!-- Sidebar Menu -->
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <li class="nav-item">
                                <a href="{{ url('/admin/home')}}" class="nav-link {{ (url()->current() == url('/admin/home')) ? 'active':'' }}">
                            ...
                            <li class="nav-item {{ (str_contains(url()->current(), 'admin/cars')) ? 'menu-is-opening menu-open active':'' }} ">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="{{ url('admin/cars') }}" class="nav-link {{ (url()->current() == url('/admin/cars')) ? 'active':'' }}">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Car List</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ url('/admin/cars/add') }}" class="nav-link {{ (url()->current() == url('/admin/cars/add')) ? 'active':'' }}">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Add Car</p>
                                        </a>
                                    </li>
                            ...
                            <li class="nav-item {{ (str_contains(url()->current(), 'admin/oneway')) ? 'menu-is-opening menu-open':'' }} ">
                                <a href="#" class="nav-link">
                                    <i class="nav-icon fas fa-car-alt"></i>
                                    <p>
                                        One Way
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="{{ url('admin/oneway') }}" class="nav-link {{ (url()->current() == url('admin/oneway')) ? 'active':'' }}">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Oneway Cabs</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ url('admin/oneway/add') }}" class="nav-link {{ (url()->current() == url('admin/oneway/add')) ? 'active':'' }}">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Add Oneway Route</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ url('admin/oneway/bookings') }}" class="nav-link {{ (url()->current() == url('admin/oneway/bookings')) ? 'active':'' }}">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Bookings</p>
                                        </a>
                                    </li>
                            ...
                            <li class="nav-item">
                                <a href="{{ url('/admin/enquiries')}}" class="nav-link {{ (url()->current() == url('/admin/enquiries')) ? 'active':'' }}">
                            ...
                            <li class="nav-item">
                                <a href="{{ url('/admin/blogs')}}" class="nav-link {{ (url()->current() == url('/admin/blogs')) ? 'active':'' }}">
                            ...
                            <li class="nav-item">
                                <a href="javascript:void(0)" class="nav-link" data-toggle="modal" data-target="#modal-logout">
        ...
        <script src="{{ URL::asset('/assets/admin/plugins/pace-progress/pace.min.js') }}"></script>
